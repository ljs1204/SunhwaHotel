...
<!-- 컨텐츠 영역 START - SI 20220314 -->
			...
			<div class="col-md-10 tab-content" id="nav-tabContent" data-aos="fade-up" data-aos-duration="1000">
				...
				<div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
					...
					<form action="" method="">
						<h4 style="color: #633e12;">문의글 상세보기</h4>
						...
						<table class="table table-bordered">
							<tbody>
								<tr>
									<th scope="row">글번호</th>
									<td colspan="2">${tomemberboarddetail.board_num}</td>
								</tr>
								<tr>
									<th scope="row">작성일자</th>
									<td colspan="2">${tomemberboarddetail.reg_datetime}</td>
								</tr>								<tr>
									<th scope="row">작성자</th>
									<td colspan="2">${tomemberboarddetail.mem_id}</td>
								</tr>
								<tr>
									<th scope="row">제목</th>
									<td colspan="2">${tomemberboarddetail.board_title}</td>
								</tr>
								
								<tr>
									<th scope="row">내용</th>
									<td colspan="2">${tomemberboarddetail.board_content}</td>
								</tr>
							</tbody>
						</table>
