                  ...
                  <div class="row full-height align-items-center">
                    <div class="col-md-6 mx-auto">
                      <ul class="list-unstyled menu">
                        ...
                        <li><a href="mypage2">mypage2</a></li>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-12 col-lg-4 order-lg-1" data-aos="fade-up">
            <h2 class="heading">Welcome!<br/>선화 호텔!</h2>
            <p class="mb-4">세계 럭셔리 호텔들과 어깨를 나란히 하고 있는
선화 호텔은 고객 한 분 한 분을 배려하는 기품있는 서비스로
세계 각국의 수반들과 외교, 경제, 문화 등의 분야의 명사로부터
찬사를 받고 있으며, Conde Nast Traveler, Travel & Leisure,
Zagat, Euromoney등 권위 있는 해외 매체로부터 매년 한국 최고의 호텔로 선정되고 있습니다.
</p>
          ...
          <div class="col-md-12">
            <div class="home-slider major-caousel owl-carousel mb-5" data-aos="fade-up" data-aos-delay="200">
              <div class="slider-item">
                <a href="resources/images/slider-1.jpg" data-fancybox="resources/images" data-caption="Caption for this image"><img src="resources/images/slider-1.jpg" alt="Image placeholder" class="img-fluid"></a>
              </div>
              <div class="slider-item">
                <a href="resources/images/slider-2.jpg" data-fancybox="resources/images" data-caption="Caption for this image"><img src="resources/images/slider-2.jpg" alt="Image placeholder" class="img-fluid"></a>
              </div>
              <div class="slider-item">
                <a href="resources/images/slider-3.jpg" data-fancybox="resources/images" data-caption="Caption for this image"><img src="resources/images/slider-3.jpg" alt="Image placeholder" class="img-fluid"></a>
              </div>
              <div class="slider-item">
                <a href="resources/images/slider-4.jpg" data-fancybox="resources/images" data-caption="Caption for this image"><img src="resources/images/slider-4.jpg" alt="Image placeholder" class="img-fluid"></a>
              </div>
              <div class="slider-item">
                <a href="resources/images/slider-5.jpg" data-fancybox="resources/images" data-caption="Caption for this image"><img src="resources/images/slider-5.jpg" alt="Image placeholder" class="img-fluid"></a>
              </div>
              <div class="slider-item">
                <a href="resources/images/slider-6.jpg" data-fancybox="resources/images" data-caption="Caption for this image"><img src="resources/images/slider-6.jpg" alt="Image placeholder" class="img-fluid"></a>
              </div>
              <div class="slider-item">
                <a href="resources/images/slider-7.jpg" data-fancybox="resources/images" data-caption="Caption for this image"><img src="resources/images/slider-7.jpg" alt="Image placeholder" class="img-fluid"></a>
              </div>
            </div>
            <!-- END slider -->
          </div>
