      ...
      <div class="container">
        <div class="row site-hero-inner justify-content-center align-items-center">
          <div class="col-md-10 text-center" data-aos="fade">
            <h1 class="heading mb-3">(회원아이디)님의 마이페이지</h1>
                  ...
                  <div class="row full-height align-items-center">
                    <div class="col-md-30 mx-auto">
                      <ul class="list-unstyled menu">
                        ...
                        <li class="active"><a href="reservation.html">회원정보수정</a></li>
          ...
          <table>
      		<tr style="background-color:#212529;color:white;">
	            ...
	            <tr>
	            	<td id="title">예약현황</td>          
				 	<td>
					 	<c:if test="${info.mem_flg  eq 1}"><td>부분취소</td></c:if> 
						<c:if test="${info.mem_flg  eq 2}"><td>예약취소</td></c:if>
				 	</td> 
	            </tr> 
	            <tr>
	            	<td id="title">처리상태</td>          
				 	<td>
				 		<c:if test="${info.mem_flg  eq 1}"><td>환불 신청 완료</td></c:if> 
						<c:if test="${info.mem_flg  eq 2}"><td>부분 환불 신청 완료</td></c:if>
						<c:if test="${info.mem_flg  eq 2}"><td>환불 완료</td></c:if>
				 	</td> 
	            </tr>	
	            <tr>
	            	<td id="title">처리날짜</td>          
