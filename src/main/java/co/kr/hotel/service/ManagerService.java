...
// 20220324 달력 데이터 - SI
		...
		public ArrayList<HashMap<String, String>> memlist_listCall(MemberDTO parameter) {
			...
			ArrayList<HashMap<String, String>> listCall = dao.memlist_listCall(parameter);
			logger.info("listcall 쿼리문 실행");
			
			return listCall;
		}
		public int memlist_rangecall(MemberDTO parameter) {
			int totalCount = dao.memlist_allCount(parameter); // 일단 테이블 글이 몇개인지? 
			/*
